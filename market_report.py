...
Setup:
  ...
  Fill in the CONFIG block below, then schedule with Windows Task Scheduler.
...
SMTP_PORT = 465
SMTP_USER = "youraddress@gmail.com"          # sending account
SMTP_PASS = os.environ.get("MARKET_MAIL_PW", "")  # Gmail app password, set as env var
